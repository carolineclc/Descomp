...
def  converteArroba9bits(line):
    line = line.split('@')
    line[1] = "{0:09b}".format(int(line[1]))
    line = ''.join(line)
    return line
...
def trataReg(line):
    ...
    if len(line) == 3:
        ...
        line[1] = "{0:02b}".format(int(line[1]))
    elif len(line) == 2:
        line.append(line[1])
        line[1] = "00"
    line = " ".join(line)
...
with open(outputBIN, "w+") as f:  #Abre o destino BIN
    ...
    for line in lines:        
        ...
        #Se a linha for válida para conversão, executa
            ...
            print(instrucaoLine)
            instrucaoLine = trataReg(instrucaoLine)
            ...
            if '@' in instrucaoLine: #Se encontrar o caractere arroba '@' 
                ...
                if noveBits == False:
                    ...
                    instrucaoLine = instrucaoLine + "00000000000" #Acrescenta o valor x"00". Ex(RET): x"A" x"00"
